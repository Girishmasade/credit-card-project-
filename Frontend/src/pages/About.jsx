...
const About = () => {
  return (
    <div className="container flex flex-wrap p-6 md:p-10 items-center justify-center mx-auto">
      <div className="border border-black p-4 md:p-6 rounded-md flex flex-col gap-5 w-full max-w-2xl bg-white">
        <h1 className="text-2xl md:text-3xl font-bold items-start pb-3">About Us</h1>
